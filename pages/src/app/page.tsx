        ...
        <section id="experience" className="py-12 scroll-mt-16">
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl mx-auto space-y-8">
                ...
                <div className="p-6 bg-white dark:bg-gray-700 rounded-lg shadow-md
                  ...
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      ...
                      <p className="text-blue-600">DevRev</p>
                    </div>
                    <p className="text-gray-600 dark:text-gray-300">July 2023 - Present</p>
                  </div>
                  <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-2">
                    <li>Working on building next-gen developer-first CRM</li>
                    <li>Full stack development using React, TypeScript, and Go</li>
                    <li>Building and maintaining microservices architecture</li>
                  </ul>
                </div>
              </a>
              ...
              {/* Research Work */}
              <a 
                href="http://gandhipedia150.in:5003/CWMG/letters"
                target="_blank"
                rel="noopener noreferrer"
                className="block"
              >
                <div className="p-6 bg-white dark:bg-gray-700 rounded-lg shadow-md
                  ...
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      ...
                      <p className="text-blue-600">IIT Kharagpur</p>
                    </div>
                    <p className="text-gray-600 dark:text-gray-300">2020 - 2023</p>
                  </div>
                  <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-2">
                    <li>Project Gandhipedia: Timeline generation and event extraction from historical documents</li>
                    <li>Implemented NLP techniques for text analysis and information extraction</li>
                    <li>Developed algorithms for timeline summarization and visualization</li>
                  </ul>
                </div>
              </a>
              ...
              >
                <div className="p-6 bg-white dark:bg-gray-700 rounded-lg shadow-md
                  ...
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <p className="text-gray-600 dark:text-gray-300">May 2022 - July 2022</p>
                  </div>
                  <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-2">
                    <li>Worked on full-stack development using React and TypeScript</li>
